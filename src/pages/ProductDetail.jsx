  ...
  return (
    <div className="max-w-4xl mx-auto px-4 pt-40 pb-10 grid md:grid-cols-2 gap-10">
      ...
      <div>
        ...
        <p className="flex items-start gap-2 text-xs text-brand-dark/50 mb-4 bg-brand-orange/10 rounded-lg px-3 py-2">
          ...
          <span>Preorders open <strong>Thursday</strong> for Saturday delivery &amp; <strong>Friday</strong> for Sunday delivery.</span>
        </p>
